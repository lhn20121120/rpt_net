...
/**
 * AfTemplateOrgRelationId entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class AfTemplateOrgRelationId implements java.io.Serializable {
	...
	/** default constructor */
	public AfTemplateOrgRelationId() {
	}

	/** full constructor */
	public AfTemplateOrgRelationId(String orgId, String templateId,
			String versionId) {
		this.orgId = orgId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AfTemplateOrgRelationId))
			return false;
		AfTemplateOrgRelationId castOther = (AfTemplateOrgRelationId) other;
