...
import com.fitech.model.etl.model.pojo.EtlCallTypeInfo;
import com.fitech.model.etl.model.pojo.EtlCustomTypeInfo;
import com.fitech.model.etl.model.pojo.EtlFileServerInfo;
import com.fitech.model.etl.model.pojo.EtlFileTypeInfo;
import com.fitech.model.etl.model.pojo.EtlTaskInfo;

public class ETLLoadFileInfoVo extends ETLBaseVo{
	...
	/** default constructor */
	public ETLLoadFileInfoVo() {
	}

	/** full constructor */
	public ETLLoadFileInfoVo(Integer taskId, String fileName, String filePath, String tableCode, Integer startRow, String fileTypeCode,
			Integer recordsNum, String fileSeper,Integer callTypeId, String customTypeCode, String customWay, Integer serverId,Boolean isChange) {
		this.taskId = taskId;
