...
<link href="css/animate/theme/jquery-ui-1.8.11.redmond.css"
	...
	//	alert(templateId+"*************"+orgId);
		...
		if(templateId!=''){
			var flag=false;//2013-10-11 wxw 徽商修改
					 	/*$.ajax({   
						          type : "post",   
						          url : "/rpt_other/isExistTemplate_workTaskNodeAction.action",   
...
<body>
	...
	<s:form action="saveHzNodeInfo_workTaskNodeAction" id="form1" method="post" namespace="/">
		...
		<fieldset style="width:600px ">
			...
			<table border="0" cellspacing="20" cellpadding="10"
				...
				<tr>
					<td colspan="2" height="50px">
						<fieldset style="width:100% ;height: 40px"" >
							...
							<td width="33%">
								总行
								<s:textfield name="zTime" size="10" value=""></s:textfield>
								
							</td>
							<td width="33%">
								分行
								<s:textfield name="fTime" size="10" value="" ></s:textfield>
							</td>
							<td width="33%">
								支行
								<s:textfield name="cTime" size="10" value="" ></s:textfield>
							</td>
							</tr>
							</table>
</br>
				...
				<s:hidden id="object_templateIds" name="templateIds"></s:hidden>
						<button onclick="doSearch()">下一步</button></td>
				</tr>
			</table>
		</fieldset>
	</div>
