...
/**
 * Deletes a colAbnormityChange.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/deleteColAbnormityChange"
 *
 ...
 */
public final class DeleteColAbnormityChangeAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         com.cbrc.smis.adapter.StrutsColAbnormityChangeDelegate.remove(colAbnormityChangeForm);
      } catch (Exception e) {
