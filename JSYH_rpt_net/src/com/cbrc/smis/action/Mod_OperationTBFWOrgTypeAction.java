 ...
 */
public final class Mod_OperationTBFWOrgTypeAction extends Action {
    private static FitechException log = new FitechException(Mod_OperationTBFWOrgTypeAction.class); 
   /**
    * Performs action.
