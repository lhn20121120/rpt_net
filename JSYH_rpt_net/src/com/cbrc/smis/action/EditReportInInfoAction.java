...
/**
 * Open form for editing reportInInfo.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editReportInInfo"
 *
 ...
 */
public final class EditReportInInfoAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         reportInInfoForm = com.cbrc.smis.adapter.StrutsReportInInfoDelegate.edit(reportInInfoForm);
         session.setAttribute("reportInInfoForm", reportInInfoForm);
      } catch (Exception e) {
         getServlet().log("Create error", e);
         request.setAttribute("name", "ReportInInfo");
