...
/**
 * Deletes a calendarDetail.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/deleteCalendarDetail"
 *
 ...
 */
public final class DeleteCalendarDetailAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         com.cbrc.smis.adapter.StrutsCalendarDetailDelegate.remove(calendarDetailForm);
      } catch (Exception e) {
