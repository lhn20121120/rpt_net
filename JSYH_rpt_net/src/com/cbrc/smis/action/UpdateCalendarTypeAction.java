...
/**
 * Updates a calendarType.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/updateCalendarType"
 ...
 */
public final class UpdateCalendarTypeAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         calendarTypeForm = com.cbrc.smis.adapter.StrutsCalendarTypeDelegate.update(calendarTypeForm);
