...
/**
 * Deletes a reportData.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/deleteReportData"
 *
 ...
 */
public final class DeleteReportDataAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         com.cbrc.smis.adapter.StrutsReportDataDelegate.remove(reportDataForm);
      } catch (Exception e) {
