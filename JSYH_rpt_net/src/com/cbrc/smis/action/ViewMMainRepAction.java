...
/**
 * Displays a MMainRep. We'll first try to look for a MMainRep
 ...
 */
public final class ViewMMainRepAction extends Action {
   ...
   public ActionForward execute(
      ...
      MMainRepForm MMainRepForm = (MMainRepForm)request.getAttribute("MMainRep");
      if( MMainRepForm == null ) {
         ...
         try {
            MMainRepForm = new MMainRepForm();
            // Now set the form members with request values 
            RequestUtils.populate(MMainRepForm, request);

            MMainRepForm = com.cbrc.smis.adapter.StrutsMMainRepDelegate.edit(MMainRepForm);
      ...
      // Make a map that can be used to identify this MMainRep in any links
      HashMap urlParams = new HashMap();
  urlParams.put("repId",MMainRepForm.getRepId());
