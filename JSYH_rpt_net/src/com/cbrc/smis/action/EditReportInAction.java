...
/**
 * Open form for editing reportIn.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editReportIn"
 *
 ...
 */
public final class EditReportInAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         ...
         session.setAttribute("reportInForm", reportInForm);
      } catch (Exception e) {
         getServlet().log("Create error", e);
         request.setAttribute("name", "ReportIn");
