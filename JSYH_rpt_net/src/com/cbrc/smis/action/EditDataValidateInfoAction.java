...
/**
 * Open form for editing dataValidateInfo.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editDataValidateInfo"
 *
 * @struts.action-forward
 *    name="form"
 *    path="/struts/formDataValidateInfo.jsp"
 *    redirect="false"
 *

 */
public final class EditDataValidateInfoAction extends Action {
   ...
   public ActionForward execute(
      ...
      DataValidateInfoForm dataValidateInfoForm = new DataValidateInfoForm();
      ...
      try {
         ...
         session.setAttribute("dataValidateInfoForm", dataValidateInfoForm);
      } catch (Exception e) {
