...
/**
 * Deletes a abnormityChange.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/deleteAbnormityChange"
 *
 ...
 */
public final class DeleteAbnormityChangeAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         com.cbrc.smis.adapter.StrutsAbnormityChangeDelegate.remove(abnormityChangeForm);
      } catch (Exception e) {
