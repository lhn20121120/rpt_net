...
import com.cbrc.smis.adapter.StrutsReportInAgainDelegate;
 ...
 *
 */
public final class ViewReportInAgainAction extends Action {
	private FitechException log=new FitechException(ViewReportInAgainAction.class);
	...
	public ActionForward execute(
      ...
      throws IOException, ServletException {
        ...
        try {        
	   		//取得记录总数
        	/**疑是oracle语法(upper) 卞以刚 2011-12-22  已使用hibernate **/
	   		recordCount = StrutsReportInAgainDelegate.getRecordCountOfmanual(reportInForm,operator);
	  
	   		//显示分页后的记录
	   		if(recordCount > 0)
		   	    resList = StrutsReportInAgainDelegate.selectOfManual(reportInForm,offset,limit,operator); 
		...
		//把ApartPage对象存放在request范围内
	 	...
	 	/**
	 	 * 如果StrutsMReportInDelegate类中返回的reslist对象
	 	 * 不为空并且对象的大小大于0
