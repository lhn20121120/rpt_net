...
/**
 * Deletes a MChildReport.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/deleteMChildReport"
 *
 ...
 */
public final class DeleteMChildReportAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         com.cbrc.smis.adapter.StrutsMChildReportDelegate.remove(MChildReportForm);
      } catch (Exception e) {
