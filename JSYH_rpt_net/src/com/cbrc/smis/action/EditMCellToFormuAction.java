...
/**
 * Open form for editing MCellToFormu.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editMCellToFormu"
 *
 * @struts.action-forward
 *    name="form"
 *    path="/struts/formMCellToFormu.jsp"
 *    redirect="false"
 *

 */
public final class EditMCellToFormuAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         MCellToFormuForm = com.cbrc.smis.adapter.StrutsMCellToFormuDelegate.edit(MCellToFormuForm);
         session.setAttribute("MCellToFormuForm", MCellToFormuForm);
      } catch (Exception e) {
