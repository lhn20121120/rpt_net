...
/**
 * Open form for editing document.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editDocument"
 *
 ...
 */
public final class EditDocumentAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         ...
         session.setAttribute("documentForm", documentForm);
      } catch (Exception e) {
