...
/**
 * Displays a sysSet. We'll first try to look for a sysSet
 ...
 */
public final class ViewSysSetAction extends Action {
   ...
   public ActionForward execute(
      ...
      SysSetForm sysSetForm = (SysSetForm)request.getAttribute("sysSet");
      if( sysSetForm == null ) {
         ...
         try {
            ...
            RequestUtils.populate(sysSetForm, request);

            sysSetForm = com.cbrc.smis.adapter.StrutsSysSetDelegate.edit(sysSetForm);
      ...
      // Make a map that can be used to identify this SysSet in any links
      HashMap urlParams = new HashMap();
  urlParams.put("sysSetId",sysSetForm.getSysSetId());
