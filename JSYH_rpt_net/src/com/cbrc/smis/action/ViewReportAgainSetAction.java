...
/**
 * Displays a reportAgainSet. We'll first try to look for a reportAgainSet
 ...
 *
 * @struts.action
 *    path="/struts/viewReportAgainSet"
 *
 ...
 */
public final class ViewReportAgainSetAction extends Action {
   ...
   public ActionForward execute(
      ...
      ReportAgainSetForm reportAgainSetForm = (ReportAgainSetForm)request.getAttribute("reportAgainSet");
      if( reportAgainSetForm == null ) {
         ...
         try {
            reportAgainSetForm = new ReportAgainSetForm();
            // Now set the form members with request values 
            RequestUtils.populate(reportAgainSetForm, request);

            reportAgainSetForm = com.cbrc.smis.adapter.StrutsReportAgainSetDelegate.edit(reportAgainSetForm);
            request.setAttribute("reportAgainSet", reportAgainSetForm);
         } catch (Exception e) {
            getServlet().log("Create error", e);
            request.setAttribute("name", "ReportAgainSet");
            return mapping.findForward("ejb-finder-exception");
         }
      }

      // Make a map that can be used to identify this ReportAgainSet in any links
      HashMap urlParams = new HashMap();
  urlParams.put("rasId",reportAgainSetForm.getRasId());
  urlParams.put("repInId",reportAgainSetForm.getRepInId());
