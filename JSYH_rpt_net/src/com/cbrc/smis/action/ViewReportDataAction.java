...
/**
 * Displays a reportData. We'll first try to look for a reportData
 ...
 *
 * @struts.action
 *    path="/struts/viewReportData"
 *
 * @struts.action-forward
 *    name="view"
 *    path="/struts/viewReportData.jsp"
 *    redirect="false"
 *

 */
public final class ViewReportDataAction extends Action {
   ...
   public ActionForward execute(
      ...
      ReportDataForm reportDataForm = (ReportDataForm)request.getAttribute("reportData");
      if( reportDataForm == null ) {
         ...
         try {
            ...
            request.setAttribute("reportData", reportDataForm);
         } catch (Exception e) {
      ...
      // Make a map that can be used to identify this ReportData in any links
      HashMap urlParams = new HashMap();
  urlParams.put("childRepId",reportDataForm.getChildRepId());
  urlParams.put("versionId",reportDataForm.getVersionId());
