...
public class MActuRepSet implements Serializable {

    /** identifier field */
    private com.cbrc.smis.hibernate.MActuRepSetPK comp_id;
    ...
    /** full constructor */
    public MActuRepSet(com.cbrc.smis.hibernate.MActuRepSetPK comp_id, Integer delayTime, Integer normalTime, com.cbrc.smis.hibernate.MDataRgType MDataRgType, com.cbrc.smis.hibernate.MRepFreq MRepFreq, com.cbrc.smis.hibernate.MChildReport MChildReport) {
    ...
    /** minimal constructor */
    public MActuRepSet(com.cbrc.smis.hibernate.MActuRepSetPK comp_id) {
        this.comp_id = comp_id;
    }

    public com.cbrc.smis.hibernate.MActuRepSetPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(com.cbrc.smis.hibernate.MActuRepSetPK comp_id) {
        this.comp_id = comp_id;
    }
