...
public interface IAFDataTraceService {
	 ...
	 * @throws Exception
	 */
	public List<AFDataTraceForm> findListByAFDataTrace(AFDataTraceForm traceForm,int pageSize,int pageNo) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<AFDataTraceForm> findListByAFDataTrace(AFDataTraceForm traceForm) throws Exception;
}
