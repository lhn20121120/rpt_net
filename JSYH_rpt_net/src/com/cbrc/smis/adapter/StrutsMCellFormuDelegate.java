 ...
 * It has a set of methods to handle persistence for MCellFormu data (i.e. 
 * com.cbrc.smis.form.MCellFormuForm objects).
 * 
...
public class StrutsMCellFormuDelegate {
	...
	public static boolean delete(String cellFormuIds){
		...
		try{
			...
			if(delResCellFormu==delResCellToFormu) result=true;
		}catch(HibernateException he){
			log.printStackTrace(he);
		}finally{
   ...
   /**
    * Create a new com.cbrc.smis.form.MCellFormuForm object and persist (i.e. insert) it.
    *
    * @param   mCellFormuForm   The object containing the data for the new com.cbrc.smis.form.MCellFormuForm object
    * @exception   Exception   If the new com.cbrc.smis.form.MCellFormuForm object cannot be created or persisted.
    */
   public static com.cbrc.smis.form.MCellFormuForm create (com.cbrc.smis.form.MCellFormuForm mCellFormuForm) throws Exception {
...
// TODO error?: mCellFormuPersistence = (com.cbrc.smis.hibernate.MCellFormu)session.save(mCellFormuPersistence);
...
session.close();
   ...
   /**
    * Update (i.e. persist) an existing com.cbrc.smis.form.MCellFormuForm object.
    *
    * @param   mCellFormuForm   The com.cbrc.smis.form.MCellFormuForm object containing the data to be updated
    * @exception   Exception   If the com.cbrc.smis.form.MCellFormuForm object cannot be updated/persisted.
    */
   public static com.cbrc.smis.form.MCellFormuForm update (com.cbrc.smis.form.MCellFormuForm mCellFormuForm) throws Exception {
      com.cbrc.smis.hibernate.MCellFormu mCellFormuPersistence = new com.cbrc.smis.hibernate.MCellFormu ();
      TranslatorUtil.copyVoToPersistence(mCellFormuPersistence, mCellFormuForm);
javax.naming.InitialContext ctx = new javax.naming.InitialContext();
// TODO: Make adapter get SessionFactory jndi name by ant task argument?
...
session.close();
   ...
   /**
    * Retrieve an existing com.cbrc.smis.form.MCellFormuForm object for editing.
    *
    * @param   mCellFormuForm   The com.cbrc.smis.form.MCellFormuForm object containing the data used to retrieve the object (i.e. the primary key info).
    * @exception   Exception   If the com.cbrc.smis.form.MCellFormuForm object cannot be retrieved.
    */
   public static com.cbrc.smis.form.MCellFormuForm edit (com.cbrc.smis.form.MCellFormuForm mCellFormuForm) throws Exception {
      com.cbrc.smis.hibernate.MCellFormu mCellFormuPersistence = new com.cbrc.smis.hibernate.MCellFormu ();
      TranslatorUtil.copyVoToPersistence(mCellFormuPersistence, mCellFormuForm);
javax.naming.InitialContext ctx = new javax.naming.InitialContext();
// TODO: Make adapter get SessionFactory jndi name by ant task argument?
...
net.sf.hibernate.Session session = factory.openSession();
net.sf.hibernate.Transaction tx = session.beginTransaction();
mCellFormuPersistence = (com.cbrc.smis.hibernate.MCellFormu)session.load(com.cbrc.smis.hibernate.MCellFormu.class, mCellFormuPersistence.getCellFormuId());
tx.commit();
session.close();
      TranslatorUtil.copyPersistenceToVo(mCellFormuPersistence, mCellFormuForm);
      return mCellFormuForm;
    ...
    *
    * @param   mCellFormuForm   The com.cbrc.smis.form.MCellFormuForm object containing the data to be deleted.
    * @exception   Exception   If the com.cbrc.smis.form.MCellFormuForm object cannot be removed.
    */  
...
session.close();
    ...
    *
    * @exception   Exception   If the com.cbrc.smis.form.MCellFormuForm objects cannot be retrieved.
    */
...
session.close();
   ...
   /**
    * Retrieve a set of existing com.cbrc.smis.form.MCellFormuForm objects for editing.
    *
    * @param   mCellFormuForm   The com.cbrc.smis.form.MCellFormuForm object containing the data used to retrieve the objects (i.e. the criteria for the retrieval).
    * @exception   Exception   If the com.cbrc.smis.form.MCellFormuForm objects cannot be retrieved.
    */
...
net.sf.hibernate.Session session = factory.openSession();
net.sf.hibernate.Transaction tx = session.beginTransaction();
retVals.addAll(session.find("from com.cbrc.smis.hibernate.MCellFormu as obj1 where obj1.cellFormu='" + mCellFormuForm.getCellFormu() + "'"));
retVals.addAll(session.find("from com.cbrc.smis.hibernate.MCellFormu as obj1 where obj1.formuType='" + mCellFormuForm.getFormuType() + "'"));
tx.commit();
session.close();
      ArrayList mCellFormu_vos = new ArrayList();
      for (Iterator it = retVals.iterator(); it.hasNext(); ) {
