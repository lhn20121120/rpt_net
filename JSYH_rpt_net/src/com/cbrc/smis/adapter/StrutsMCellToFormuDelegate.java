 ...
 * It has a set of methods to handle persistence for MCellToFormu data (i.e. 
 * com.cbrc.smis.form.MCellToFormuForm objects).
 * 
...
public class StrutsMCellToFormuDelegate {
   ...
   /**
    * Create a new com.cbrc.smis.form.MCellToFormuForm object and persist (i.e. insert) it.
    *
    * @param   mCellToFormuForm   The object containing the data for the new com.cbrc.smis.form.MCellToFormuForm object
    * @exception   Exception   If the new com.cbrc.smis.form.MCellToFormuForm object cannot be created or persisted.
    */
   public static com.cbrc.smis.form.MCellToFormuForm create (com.cbrc.smis.form.MCellToFormuForm mCellToFormuForm) throws Exception {
...
// TODO error?: mCellToFormuPersistence = (com.cbrc.smis.hibernate.MCellToFormu)session.save(mCellToFormuPersistence);
...
session.close();
   ...
   /**
    * Update (i.e. persist) an existing com.cbrc.smis.form.MCellToFormuForm object.
    *
    * @param   mCellToFormuForm   The com.cbrc.smis.form.MCellToFormuForm object containing the data to be updated
    * @exception   Exception   If the com.cbrc.smis.form.MCellToFormuForm object cannot be updated/persisted.
    */
   public static com.cbrc.smis.form.MCellToFormuForm update (com.cbrc.smis.form.MCellToFormuForm mCellToFormuForm) throws Exception {
      com.cbrc.smis.hibernate.MCellToFormu mCellToFormuPersistence = new com.cbrc.smis.hibernate.MCellToFormu ();
      TranslatorUtil.copyVoToPersistence(mCellToFormuPersistence, mCellToFormuForm);
javax.naming.InitialContext ctx = new javax.naming.InitialContext();
// TODO: Make adapter get SessionFactory jndi name by ant task argument?
...
session.close();
   ...
   /**
    * Retrieve an existing com.cbrc.smis.form.MCellToFormuForm object for editing.
    *
    * @param   mCellToFormuForm   The com.cbrc.smis.form.MCellToFormuForm object containing the data used to retrieve the object (i.e. the primary key info).
    * @exception   Exception   If the com.cbrc.smis.form.MCellToFormuForm object cannot be retrieved.
    */
   public static com.cbrc.smis.form.MCellToFormuForm edit (com.cbrc.smis.form.MCellToFormuForm mCellToFormuForm) throws Exception {
      com.cbrc.smis.hibernate.MCellToFormu mCellToFormuPersistence = new com.cbrc.smis.hibernate.MCellToFormu ();
      TranslatorUtil.copyVoToPersistence(mCellToFormuPersistence, mCellToFormuForm);
javax.naming.InitialContext ctx = new javax.naming.InitialContext();
// TODO: Make adapter get SessionFactory jndi name by ant task argument?
...
session.close();
    ...
    *
    * @param   mCellToFormuForm   The com.cbrc.smis.form.MCellToFormuForm object containing the data to be deleted.
    * @exception   Exception   If the com.cbrc.smis.form.MCellToFormuForm object cannot be removed.
    */  
...
session.close();
    ...
    *
    * @exception   Exception   If the com.cbrc.smis.form.MCellToFormuForm objects cannot be retrieved.
    */
...
session.close();
      ...
      for (Iterator it = retVals.iterator(); it.hasNext(); ) {
         ...
         com.cbrc.smis.hibernate.MCellToFormu mCellToFormuPersistence = (com.cbrc.smis.hibernate.MCellToFormu)it.next();
    ...
    * @exception   Exception   If the com.cbrc.smis.form.MCellToFormuForm objects cannot be retrieved.
    */
   public static List select (String childRepId,String versionId,int offset,int limit) throws Exception {
      List result = null;
      DBConn conn= null;
      ...
      if(childRepId !=null && !childRepId.equals("") && versionId!=null && !versionId.equals(""))
      {
          String hql = "from MCellToFormu mcf where mcf.childRepId='"
                  +childRepId+"' and mcf.versionId='"+versionId+"'";
          try
          {
             conn = new DBConn();
    ...
    * @throws Exception 
    */
   public static int getRecordCount(String childRepId,String versionId) throws Exception{
       ...
       if(childRepId !=null && !childRepId.equals("") && versionId!=null && !versionId.equals(""))
       {
           String hql = "select count(*) from MCellToFormu mcf where mcf.childRepId='"
                   +childRepId+"' and mcf.versionId='"+versionId+"'";
           try
           {
              conn = new DBConn();
