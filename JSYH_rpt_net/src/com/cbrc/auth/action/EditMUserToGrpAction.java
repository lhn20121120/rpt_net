...
/**
 * Open form for editing MUserToGrp.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editMUserToGrp"
 *
 * @struts.action-forward
 *    name="form"
 *    path="/struts/formMUserToGrp.jsp"
 *    redirect="false"
 *

 */
public final class EditMUserToGrpAction extends Action {
   ...
   public ActionForward perform(
      ...
      try {
         MUserToGrpForm = null;//com.cbrc.auth.adapter.StrutsMUserToGrpDelegate.edit(MUserToGrpForm);
         session.setAttribute("MUserToGrpForm", MUserToGrpForm);
      } catch (Exception e) {
