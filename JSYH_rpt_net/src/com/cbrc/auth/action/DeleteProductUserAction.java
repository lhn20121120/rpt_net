...
/**
 * Deletes a productUser.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/deleteProductUser"
 *
 ...
 */
public final class DeleteProductUserAction extends Action {
   ...
   public ActionForward perform(
      ...
      try {
         com.cbrc.auth.adapter.StrutsProductUserDelegate.remove(productUserForm);
      } catch (Exception e) {
