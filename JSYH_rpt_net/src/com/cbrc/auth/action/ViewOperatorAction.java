 ...
 */
public final class ViewOperatorAction extends Action {
    ...
    public ActionForward execute(
       ...
       throws IOException, ServletException {
		...
		String newusern = (String) request.getAttribute("userName");
		if(!StringUtil.isEmpty(newusern) && StringUtil.isEmpty(operatorForm.getUserName())){
			operatorForm.setUserName(newusern);
		}
