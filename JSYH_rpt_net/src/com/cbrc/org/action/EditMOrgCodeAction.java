...
/**
 * Open form for editing MOrgCode.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editMOrgCode"
 *
 ...
 */
public final class EditMOrgCodeAction extends Action {
   ...
   public ActionForward perform(
      ...
      MOrgCodeForm MOrgCodeForm = new MOrgCodeForm();
      ...
      try {
         ...
         session.setAttribute("MOrgCodeForm", MOrgCodeForm);
      } catch (Exception e) {
