...
/**
 * Open form for editing MOrgCl.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editMOrgCl"
 *
 ...
 */
public final class EditMOrgClAction extends Action {
   ...
   public ActionForward perform(
      ...
      try {
         MOrgClForm = com.cbrc.org.adapter.StrutsMOrgClDelegate.edit(MOrgClForm);
         session.setAttribute("MOrgClForm", MOrgClForm);
      } catch (Exception e) {
