...
/**
 * Deletes a MVirOrgRlt.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/deleteMVirOrgRlt"
 *
 ...
 */
public final class DeleteMVirOrgRltAction extends Action {
   ...
   public ActionForward perform(
      ...
      MVirOrgRltForm MVirOrgRltForm = new MVirOrgRltForm();

      // Now set the form members with request values 
      RequestUtils.populate(MVirOrgRltForm, request);
      try {
         com.cbrc.org.adapter.StrutsMVirOrgRltDelegate.remove(MVirOrgRltForm);
      } catch (Exception e) {
