...
/**
 * Open form for editing MToRepOrg.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editMToRepOrg"
 *
 * @struts.action-forward
 *    name="form"
 *    path="/struts/formMToRepOrg.jsp"
 *    redirect="false"
 *

 */
public final class EditMToRepOrgAction extends Action {
   ...
   public ActionForward perform(
      ...
      try {
         MToRepOrgForm = com.cbrc.org.adapter.StrutsMToRepOrgDelegate.edit(MToRepOrgForm);
         session.setAttribute("MToRepOrgForm", MToRepOrgForm);
      } catch (Exception e) {
