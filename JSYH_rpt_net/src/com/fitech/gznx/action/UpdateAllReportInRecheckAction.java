 ...
 *
 */
public final class UpdateAllReportInRecheckAction extends Action {
	private static FitechException log=new FitechException(UpdateAllReportInRecheckAction.class);
