...
import com.fitech.gznx.service.ReportCheck;

public class AFReportCheckAction extends Action {
			...
			HttpServletResponse response) throws IOException, ServletException
	{
     ...
     if(request.getAttribute("templateName")!=null)
         ...
         try{
        	 ...
        	 /**已使用hibernate 卞以刚 2011-12-22
        	  * 影响对象：AfTemplate**/
              PageListInfo pageList= ReportCheck.getTemplates(mChildReportForm,reportFlg,curPage);  
