...
public class CustomViewAFReportAction extends Action {
	private static FitechException log = new FitechException(CustomViewAFReportAction.class);
			...
			HttpServletResponse response) throws IOException, ServletException
	{
     ...
     if(request.getParameter("templateName")!=null)
         ...
         try{
        	 ...
        	 /**已使用hibernate 卞以刚 2011-12-21
        	  * 影响对象：AfTemplate**/
              PageListInfo pageList= AFTemplateDelegate.getCustomTemplates(mChildReportForm,reportFlg,curPage,operator);  
