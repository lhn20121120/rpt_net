 ...
 *
 */
public final class UpdateReportNXAction extends Action {
	private static FitechException log=new FitechException(UpdateReportNXAction.class);
	...
	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request
		...
		try {
			...
			if(repInIds!=null && !repInIds.equals("")){			  
				...
				if(flag.equals(String.valueOf(Config.CHECK_FLAG_NO))) reportInForm.setForseReportAgainFlag(Config.FORSE_REPORT_AGAIN_FLAG_1);		  
			}    	  
