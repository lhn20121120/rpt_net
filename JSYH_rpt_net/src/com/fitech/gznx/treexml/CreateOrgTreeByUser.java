...
public class CreateOrgTreeByUser {
	...
	public static String createByUser(String operatorId, List purviewOrgList,
		...
		try {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				// if (i == 0)
				CreateOrgTreeByUser.createByUserIterator(operatorId,
	...
	public static void createByUserIterator(String operatorId,
		...
		for (int i = 0; i < srcList.size(); i++) {
			...
			CreateOrgTreeByUser.createByUserIterator(operatorId, srcE, dstE,
					purviewOrgList);
		}
	}
	...
	public static String createAllOrg(Operator operator, List checkedList,boolean isContainCollect) {
		...
		try {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				CreateOrgTreeByUser.createAllOrgIterator(srcElement,
	...
	public static void createAllOrgIterator(Element srcElement,
		...
		for (int i = 0; i < srcList.size(); i++) {
			...
			CreateOrgTreeByUser.createAllOrgIterator(srcE, dstE, checkedList);
		}
	}
