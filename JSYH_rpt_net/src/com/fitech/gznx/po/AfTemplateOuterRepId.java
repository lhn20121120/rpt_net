...
/**
 * AfTemplateOuterRepId entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class AfTemplateOuterRepId implements java.io.Serializable {
	...
	/** default constructor */
	public AfTemplateOuterRepId() {
	}

	/** full constructor */
	public AfTemplateOuterRepId(String orgId, String templateId, String versionId) {
		this.orgId = orgId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AfTemplateOuterRepId))
			return false;
		AfTemplateOuterRepId castOther = (AfTemplateOuterRepId) other;
