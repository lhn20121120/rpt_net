				...
				if(list!=null && list.size()>0){
					...
					for(int i=0;i<list.size();i++){
						...
						if(reportForm[1] != null){
							if(reportForm[2] != null&&reportForm[3] != null){
								lname=new StringBuffer().append("[").append((String)reportForm[3]).append("]").append((String)reportForm[1]).append("-").append(reportForm[2]).toString();
							} else {
