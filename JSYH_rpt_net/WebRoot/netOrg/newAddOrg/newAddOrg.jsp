...
<%
	...
	java.util.List maxOrgNetList = com.fitech.net.adapter.StrutsMRegionDelegate.selectRegions(maxOrgType.getOrgTypeId()) != null ? com.fitech.net.adapter.StrutsMRegionDelegate
			.selectRegions(maxOrgType.getOrgTypeId())
...
<%
		for (int i = 0; i < orgNetList.size(); i++)
		{
			...
			String preOrgTypeId = "";
			com.fitech.net.hibernate.OrgType orgType = com.fitech.net.adapter.StrutsOrgTypeDelegate.findPreOrgTypeId(orgNetForm_orgType
			.getOrg_type_id());
			if (orgType != null && orgType.getOrgTypeId() != null)
		preOrgTypeId = orgType.getOrgTypeId().toString();
...
<%
		for (int i = 0; i < regionList.size(); i++)
		{
			...
			if (mRegionForm.getPre_region_id() != null)
		preRegionId = mRegionForm.getPre_region_id().toString();
			...
			if (preMRegion != null && preMRegion.getRegionName() != null)
		preRegionName = preMRegion.getRegionName();
				...
				<div style="width:100%; height:350;background-color:#f5f5f5;border :1px solid Silver; overflow:auto;">
					...
					<table border="0" width="100%" align="center" cellspacing="1" cellpadding="7">
						<TR>
							...
							<TD>
								<html:text property="org_id" size="20" styleClass="input-text" maxlength="20" />
							</TD>
						</TR>
						<TR>
							<TD align="right">
						...
						<TR>
							...
							<TD>
								<html:select property="org_type_id" onchange="orgType_Change(pre_org_id)">
									<html:option value="-1">--请选择机构类型--</html:option>
