...
<html:html locale="true">
  ...
  <body>
	<table border="0" width="90%" align="center">
		...
		<html:form action="/insertOrgLayer" method="post">
					...
					<TR align="center" valign="middle" bgcolor="#FFFFFF">
					  <TD>
						<table border="0" width="100%" align="center" cellspacing="1" cellpadding="4">
						  <TR>
						    <TD align="center">机构级别名称：<html:text property="org_layer_name" size="20" styleClass="input-text" maxlength="20"/>
						    </TD>
				          </TR>
					           <TR>
					             <TD align="center">
