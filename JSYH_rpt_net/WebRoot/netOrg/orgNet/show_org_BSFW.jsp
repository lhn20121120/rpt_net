...
<body>
	...
	<table width="80%"  border="0" align="center">
		...
		<tr>
			<td align="center">
				<html:button property="submit" value="保  存" styleClass="input-button" onclick="submitData()"/>	   			
				<html:button property="back" value="返  回" styleClass="input-button" onclick="back()"/>
			</td>
		</tr>
	</table> 		  
</body>
