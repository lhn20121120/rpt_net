			          ...
			          <tr>
			         	 <td align="center" bgcolor="#ffffff" width="50%">
				         	 ...
				         	 %>
			               	...
			               	原子行分类名称:<input type ="text" class="input-text" name="oldorgClsNm" value="<%=orgClsNm%>" size="20" readonly>
			             </td> 
			             <td align="center" bgcolor="#ffffff" width="50%">
				         	 	<%
				         	 	...
				         	 	<input type="hidden" name="orgClsId" value="<%=orgClsId%>">
				               	新子行分类名称:<html:text property="orgClsNm" styleClass="input-text" size="20"/>
				             </td>
			          </tr>
			          ...
			          <tr>
				         	 ...
				         	 <%
				         	 	...
				         	 	<input type="hidden" name="orgClsId" value="<%=orgClsId2%>">				         	 	
				               	新子行分类类型:<html:text property="orgClsType" styleClass="input-text" size="20"/>
				             </td>
				             <td align="center" bgcolor="#ffffff" width="50%">				         	 	
				             </td>           
				          </tr>
