...
<body>
	...
	<html:form action="/collectType/saveCollectType" method="post" styleId="form1">	
		...
		<table width="60%" border="0" align="center">
			<tr align="left">
				<td>汇总方式名称：<html:text property="collectName" size="30" styleClass="input-text" maxlength="20"/></td>
			</tr>
		</table><br>	
		<table width="60%" border="0" align="center">
			<tr>
			    ...
			    <td width="23%">
			    <td width="39%" align="center" valign="middle">可以汇总的机构</td>
			</tr>
			<tr>
				<td align="center">
					<p>
		...
		<table width="60%" border="0" align="center">
			<tr>
			    ...
			    <td width="23%">
			    <td width="39%" align="center" valign="middle">需要汇总的报表</td>
			</tr>
			<tr>
				<td align="center">
					<p>
		...
		<table width="80%"  border="0" align="center">
			<tr>
 		  	...
 		  	<tr>
   				<td align="right">
   					<html:button property="save" value="保  存" styleClass="input-button" onclick="submitData()"/>&nbsp;   					
