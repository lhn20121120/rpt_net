	...
	<html:base/>
		...
		<script language="javascript">
			...
			function changeLogin(obj){
				...
				if(obj.value=="2"){
					document.form1.action="../rpt_net_cunzhen/userLogin.do";
				}
				if(obj.value=="1"){
					document.form1.action="../rpt_net/userLogin.do";
				}
				document.form1.submit();
			}
          ...
          <td width="247" valign="top">
	          <table width="100%" border="0" cellpadding="0" cellspacing="0" background="image/login_r5_c3.jpg">
	            ...
	            <tr>
	              <td height="35">&nbsp;</td>
	              <td valign="top" >
	                      <input name="userName" type="text" size="20" maxlength="20" value="admin"></td>
	              <td>&nbsp;</td>
	            </tr>
	            <tr>
	              <td height="35">&nbsp;</td>
	              <td valign="top" >
	              	<input type="password" name="password" size="20" maxlength="40" autocomplete="off"  value="fitech"/>
	              </td>
	              <td>&nbsp;</td>
	            </tr>
	            <tr>
	            ...
	            <tr style="height: 30px">
	              <td>&nbsp;</td>
	              <td colspan="2">
	              		<select onchange="changeLogin(this)" style="width: 150px">
	              			<option value="1" selected="selected">总行登录</option>
	              			<option value="2">村镇银行登录</option>
	              		</select>
