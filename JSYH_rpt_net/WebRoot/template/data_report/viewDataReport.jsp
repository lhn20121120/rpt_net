...
<head>
	...
	<SCRIPT language="javascript">
		  ...
		  var _term ;		
		    ...
		    function _view_LSBS(childRepId,versionId,year,term,curId,dataRgId,actuFreqID,orgId){
		    	...
		    	var repNames = document.getElementById("repName");	
		    	 ...
		    	 location.href="<%=request.getContextPath()%>/offLineReport.do?" + "childRepId=" + childRepId 
		    	 + "&versionId=" + versionId 
		    	 + "&year=" + year 
		    	 + "&term=" + term 
		    	 + "&curId=" + curId 
		    ...
		    function _view_PLBS(){
		    	...
		    	location.href="<%=request.getContextPath()%>/template/data_report/upMoreReport.jsp?year="+ year.value +"&term=" + term.value+"&curPage"+curPage;
		    }
		...
		function selectReport(){
			...
			var url = "<%=request.getContextPath()%>/viewDataReport.do?date="+date+"&repName="+repName+"&orgId="+orgId+"&curPage="+curPage;
			location.href= url;
		}
					...
					<table cellspacing="0" cellpadding="0" border="0" width="100%" align="center">
						...
						<tr>
							...
							<td height="23" align="left">
								报表机构：
								<html:text property="orgName" readonly="true" size="23" style="width:150px;cursor:hand" onclick="return showTree1()" style="input-text" value="<%=orgName %>" ></html:text>
						...
						if(true){//美国银行无此功能
							...
							if(Config.ISFORCEREP){
								if(operatorOrgId!=null && operatorOrgId.equals(com.fitech.gznx.common.Config.HEAD_ORG_ID) 
										/*&& searchOrgId_2!=null && !searchOrgId_2.equals(operatorOrgId)*/){
							%>
								&nbsp;&nbsp;∷&nbsp;&nbsp;
						...
						<logic:iterate id="viewReportIn" name="Records">							
							<TR bgcolor="#FFFFFF">
								<TD align="center">
									...
									<logic:empty name="viewReportIn" property="repInId">--</logic:empty>
								</TD>
								<TD align="center">
								...
								<TD align="center">
									<logic:notEmpty name='viewReportIn' property='repInId'>	
										<a href="javascript:viewExcel('<bean:write name="viewReportIn" property="repInId" />')">
