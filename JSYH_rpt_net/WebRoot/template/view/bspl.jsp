			...
			<TR bgcolor="#FFFFFF">
				...
				<logic:present name="Records" scope="request">
					<logic:iterate id="item" name="Records">
						<tr bgcolor="#FFFFFF">
							<TD align="center">
								<logic:present name="item" property="dataRgDesc">
									<bean:write name="item" property="dataRgDesc"/>		
								</logic:present>
								<logic:notPresent name="item" property="dataRgDesc">
									无
								</logic:notPresent>
							</TD>
							<td align="center">
