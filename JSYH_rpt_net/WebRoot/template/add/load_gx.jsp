...
<html:html locale="true">
			 ...
			 */
			  ...
			  */
			  function _back(){
			  	...
			  	window.location="bjgx.jsp?childRepId=" + form.elements['childRepId'].value +
	...
	<body>
		...
		<table border="0" cellpadding="4" cellspacing="1" width="60%" class="tbcolor">
			...
			<tr>
				<td bgcolor="#FFFFFF">
					<html:form method="post" action="/template/uploadBJGX.do?flag=add" enctype="multipart/form-data" onsubmit="return _submit(this)">
