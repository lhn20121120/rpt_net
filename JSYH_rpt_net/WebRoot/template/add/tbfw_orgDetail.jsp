...
<html:html locale="true">
	...
	<html:form action="/template/viewTBFWOrgInfo" method="post">
			...
			<tr>
				<td align="center" width="100%">
					<table width="100%" border="0" cellpadding="4" cellspacing="0">
						<tr>
							<td align="center">
								请输入要查询的机构名称：<html:text styleClass="input-text" property="orgName" size="40"/>&nbsp;
						...
						<tr>
							<td align="center">
								<fieldset id="fieldset">
									<legend>
										<strong>&nbsp;选择填报的金融机构</strong>
									</legend>
									<br>
									<table width="96%" border="0" align="center" cellpadding="4" cellspacing="1" class="tbcolor">
											<tr class="tableHeader">
												<td width="10%" align="center"></td>
												<td width="60%" align="center">机构名称</td>
												<td width="30%" align="center">机构类型</td>
											</tr>
									<html:form action="/template/operationTBFWOrgType" method="post" styleId="form2">
