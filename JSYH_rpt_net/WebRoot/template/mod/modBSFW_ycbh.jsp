...
<head>
	...
	<script language="javascript">
			...
			{
					var objFrm=document.forms['frmSel'];
					window.location="<%=request.getContextPath()%>/template/mod/editYCBHInit.do" +
...
<body>
	<%
		...
		int i = 1;
	%>
	<html:form action="/template/ycbh/UpdataYCBHAction" method="post" styleId="frmSel">
