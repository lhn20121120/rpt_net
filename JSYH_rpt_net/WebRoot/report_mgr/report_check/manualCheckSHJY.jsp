		...
		function _batchCheck(){
			...
			if(repInIds==""){
				...
				if(confirm("您确定要批量校验吗?\n")==true){
					location.href="<%=request.getContextPath()%>/dateQuary/shjyManualCheckRep.do?" + qry;
				}	
			}
		}
...
<body>
	...
	<table cellspacing="0" cellpadding="4" border="0" width="98%" align="center">
		<html:form action="/dateQuary/manualCheckRepSHJY" method="post" styleId="frm" onsubmit="return _submit(this)">
	...
	<logic:present name="form" scope="request">
		<table cellSpacing="0" cellPadding="4" width="98%" border="0" align="center">
			<tr>
				<td>
					<input type="button" value="校验选中" class="input-button" onclick="_batchCheck()">
					&nbsp;
					<input type="button" value="校验全部" class="input-button" onclick="_batchAllCheck()">					
				</td>
			</tr>	
		</table>
	</logic:present>
	...
	<table cellSpacing="0" cellPadding="4" width="98%" border="0" align="center">
		<html:form action="/dateQuary/manualCheckRepSHJY" method="post" styleId="frmChk">
			<tr>
				<td>
		...
		<TR>
			<TD>
				<jsp:include page="../../apartpage.jsp" flush="true">
					<jsp:param name="url" value="../../dateQuary/manualCheckRepSHJY.do" />
				</jsp:include>
			</TD>
		</TR>
	</table>
