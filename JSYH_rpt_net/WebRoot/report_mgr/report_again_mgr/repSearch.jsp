...
<head>
	...
	<SCRIPT language="javascript">
		...
		function _add(repInId){
			...
			location.href="<%=request.getContextPath()%>/report/reportAgainInitSet.do?" + qry;
		}
		...
		function _batchSet(){
			...
			if(repInIds==""){
				...
				window.location="<%=request.getContextPath()%>/report_mgr/report_again_mgr/batchAgain.jsp?" + qry;
			}
		}
...
<body>
	...
	<table cellspacing="0" cellpadding="4" border="0" width="98%" align="center">
		<html:form action="/report/repSearch" method="post" styleId="frm">
	...
	<logic:present name="form" scope="request">
		<table cellSpacing="0" cellPadding="4" width="98%" border="0" align="center">
			<html:form action="/dateQuary/saveCheckRep" method="post" styleId="frm1">
				<tr>
					<td>
						...
						<logic:present name="form" scope="request">
							<logic:iterate id="viewReportIn" name="form">
								...
								<TR bgcolor="#FFFFFF">
									...
									<TD align="center">
										<a href="<%=request.getContextPath()%>/servlets/toExcelServlet?repInId=<bean:write name='viewReportIn' property='repInId'/>" target="_blank">
		...
		<TR>
			<TD>
				<jsp:include page="../../apartpage.jsp" flush="true">
					<jsp:param name="url" value="../../report/repSearch.do" />
				</jsp:include>
			</TD>
		</TR>
	</table>
