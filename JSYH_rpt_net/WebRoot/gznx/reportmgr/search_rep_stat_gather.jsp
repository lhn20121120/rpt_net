...
<body>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="98%" align="center">
		<html:form action="/reportSearch/viewReportGatherStat" method="post" styleId="frm" onsubmit="return _submit(this)">
...
<%-- 								<td height="25" align="left">
								...
								<td align="left"><html:submit styleClass="input-button" value=" 查 询 " />
		...
		<TR>
			<TD>
				<jsp:include page="../../apartpage.jsp" flush="true">
					<jsp:param name="url" value="../../reportSearch/viewReportGatherStat.do" />
				</jsp:include>
			</TD>
		</TR>
	</table>
