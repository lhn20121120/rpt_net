						...
						<logic:present name="<%=Config.RECORDS%>" scope="request">
							...
							<logic:iterate id="item" name="<%=Config.RECORDS%>" scope="request" indexId="index">
								<tr bgcolor="#FFFFFF">
									...
									<td align="center">
									<a
										href="<%=request.getContextPath()%>/updatecheck.do?templateId=<bean:write name="item" property="childRepId"/>&versionId=<bean:write name="item" property="versionId"/>&formulaId=<bean:write name="item" property="cellFormuId"/>">修改</a>
									</td>
								</tr>
								<%count++;%>
							</logic:iterate>
