				...
				<fieldset id="fieldset">
					<table cellspacing="0" cellpadding="0" border="0" width="100%" align="center">
						...
						<tr>
							...
							<td>
									报表机构：<input type="hidden" name="orgId" id="orgId" value="${orgId}"/>
											
								<input name="orgName" id="orgName" readonly="true" size="23" style="width:150px;cursor:hand" onclick="return showTree1()" style="input-text" value="${orgName}" />
