...
<script language="javascript">
		 function dosubmit(){  
			...
			document.getElementById('win_orgList').value=checkId;
			document.getElementById('win_templateId').value=templateId.value;
			document.getElementById('win_versionId').value=versionId.value;
			document.getElementById('win_curId').value=curId.value;
			document.getElementById('win_repFreqId').value=repFreqId.value;
			document.getElementById('win_startDate').value=startDate.value;
			document.getElementById('win_endDate').value=endDate.value;
			document.getElementById('win_meaStr').value=submitOnRight();
			
			document.getElementById('win_frm').submit();
	     }
...
<body>
										...
										<td align="center" bgcolor="#ffffff" width="80%" colspan="4">
											<TABLE border="0" width="100%" align="center" cellpadding="0"
												...
												<tr>
													...
													<td align="left" bgcolor="#ffffff" width="45%" valign="top">
													...
													<td align="left" valign="top">
														<table align="center">
															...
															<tr>
																<td colspan="4" bgcolor="#ffffff" align="center"><br>
																	<input type="button" value="查  询" Class="input-button" 
																		onclick="dosubmit()" />
																	&nbsp;&nbsp;
	...
	<%-- 由于原有使用get的方式打开新窗口，此时指标ID如果过多的话，会导致传递值遗失，因此使用form提交至target="_blank"的方式实现 --%>
	<form id="win_frm" action="<%=request.getContextPath()%>/viewCustomAFReportDetail.do" target="_blank" method="post">
		<input type="hidden" id="win_forwardflg" name="forwardflg" value="1">
		<input type="hidden" id="win_orgList" name="orgList">
		<input type="hidden" id="win_templateId" name="templateId">
		<input type="hidden" id="win_versionId" name="versionId">
		<input type="hidden" id="win_curId" name="curId">
		<input type="hidden" id="win_repFreqId" name="repFreqId">
		<input type="hidden" id="win_startDate" name="startDate">
		<input type="hidden" id="win_endDate" name="endDate">
		<input type="hidden" id="win_meaStr" name="meaStr">
	</form>
	<script>
