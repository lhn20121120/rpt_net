						...
						<table cellSpacing="0" cellPadding="4" width="98%" border="0" align="center">				
							<tr>							
								...
								<td height="25" align="left">
									报表机构：
									<html:text property="orgName" readonly="true" size="20" style="width:150px;cursor:hand" onclick="return showTree1()" style="input-text" ></html:text>
				...
				<TR>
					<TD>
						<TABLE cellSpacing="1" cellPadding="4" width="100%" border="0" class="tbcolor">
							<tr class="titletab">
								<th colspan="10" align="center" id="list"><strong>报表列表</strong></th>
							</tr>
							<TR class="middle">
								...
								<TD class="tableHeader" width="30%">报表名称</TD>																
								...
								<% } %>
								<TD class="tableHeader" width="8%">报表币种</td>
