...
<html:html locale="true">
	...
	<body>
		...
		<html:form action="/afreportcheck.do" method="POST" styleId="frmChk">
		...
		<table cellSpacing="0" cellPadding="4" width="98%" border="0" align="center">
			...
			<TR>
				...
				<TD width="20%" align="center">
					<html:text name="form" property="templateName" size="15"  styleClass="input-text"/>
				</TD>
						...
						<logic:present name="Records" scope="request">
							<logic:iterate id="item" name="Records">
								<TR bgcolor="#FFFFFF">
									...
									<TD align="center">
										<a href="<%=request.getContextPath()%>/check.do?templateId=<bean:write name="item" property="templateId"/>&templateName=<bean:write name="item" property="templateName"/>&versionId=<bean:write name="item" property="versionId"/>&templateType=<bean:write name="item" property="templateType"/>">查看</a>
									</TD>
								</TR>
							</logic:iterate>
						</logic:present>
						...
						<table cellSpacing="1" cellPadding="4" width="100%" border="0">
							<tr>
								...
								<jsp:include page="../../apartpage.jsp" flush="true">
									<jsp:param name="url" value="../../afreportcheck.do" />
								</jsp:include>
								</TD>
							</tr>
						</table>
