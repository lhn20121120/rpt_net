...
<body>
	...
	<html:form action="/popedom_mgr/updateMPurBankLevel" method="post" styleId="form1">			
			...
			<table width="78%"  border="0" align="center">
		    	...
		    	<tr>
			      <td align="center">
					  <html:select styleId="allReport" property="childRepId" size="18" multiple="true" style="width:300">
		        ...
		        <td align="center" valign="middle">
		      	...
		      	<td align="center">
		          <html:select styleId="selectReport" property="selectRepList" size="18" multiple="true"  style="width:300">
