...
<head>
	...
	<script language="javascript">
		...
		function submitData()
		{
			...
			//alert(selectData);		
			window.location = "../orgmanage/org_tool_update.do?id=<bean:write name="orgId"/>&selectedMenuIds="+selectData;
		}
	</script>
</head>
...
<body>
	...
	<html:form action="/popedom_mgr/updateRoleTool" method="post">
		<table width="60%"  border="0" align="center">
		    	...
		    	<tr>
			      <td align="center">
					  <html:select styleId="allMenu" property="menuId" size="18" multiple="true" style="width:180">
		        ...
		        <td align="center" valign="middle">
		      	...
		      	<td align="center">
		          <html:select styleId="selectMenu" property="selectedMenuIds" size="18" multiple="true"  style="width:180">
