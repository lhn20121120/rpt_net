...
<%
	...
	boolean isPortal = Config.PORTAL;
%>
				...
				<td vAlign="bottom" align="right" width="224" background="image/tiao.gif">
					<table cellSpacing="0" cellPadding="5" width="280" border="0">
						<tr>
							...
							<a href="/rpt_other/pendingTaskAction!initSearch.action" target="mainFrame">主页</a>
							</td>
							<td>|</td>
							<%if(isPortal){ %>
							<td>
							<a href="javascript:window.top.location='/portal/login.action?appName=rpt_net&username=<%=userName%>'">切换</a>
							</td>
							<td>|</td>
							<%} %>
							<td  align="center">
