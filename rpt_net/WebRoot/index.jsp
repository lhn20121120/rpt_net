...
<html:html locale="true">
	...
	<frameset id="superFrame" name="superFrame" rows="80,*" cols="*" border="0" frameSpacing="0" frameBorder="0">
		<frame name="topFrame" scrolling="auto" noresize target="contents" src="top.jsp">
		<frameset name="firstFrame" rows="*" cols="170,*" framespacing="0" frameborder="no" border="0">
			...
			<frameset rows="1,*" cols="*" framespacing="0" frameborder="no" border="0">
				<frame name="middleFrame" target="mainFrame" src="middle.htm" noresize scrolling="auto">
				<frameset rows="*" cols="1,*,1" framespacing="0" frameborder="no" border="0">
					<frame name="plugFrame" target="mainFrame" src="plug.htm" scrolling="auto" noresize>
					<frame name="mainFrame" target="mainFrame" src="mainFrame.jsp">
					<frame name="rightFrame" target="mainFrame" src="right.htm" scrolling="auto" noresize>
				</frameset>
			</frameset>
		</frameset>
		<noframes>
