...
<script>
	...
	function createExcel()
	{
		...
		var url = "<%=request.getContextPath()%>/template/protect/createExcel.do?isAllRep=" +isAllRep+"&childRepId="+childRepId+"&version="+version+"&reptDate="+reptDate+"&isOrgLevel="+isOrgLevel;
		window.location=url;
			...
			<tr align="center" bgcolor="#ffffff">
				<td>
					...
					<select name="isOrgLevel" >
						<%List orglist = utilOrgForm.getOrgLevel();
