...
<body background="../../image/total.gif">
	...
	<p class="suoyinlan" align="left">当前位置<span>&gt;&gt;</span>报表管理<span>&gt;&gt;</span>报表定义管理<span>&gt;&gt;</span>模板查看<span>&gt;&gt;</span>查看表内表间关系
		...
		<tr>
			<td>
				...
				<table border="0" cellpadding="0" cellspacing="4" width="90%" align="center">
					<tr>
						<td align="center">
							<input type="button" class="input-button" onclick="history.back(-1)" value=" 返 回 ">
						</td>
					</tr>
				</table>
