...
<body>
	...
	<html:form action="/template/updateEtlIndexFormual" method="post" styleId="frmSel" onsubmit="return _submit(this)">
		...
		<table cellSpacing="1" cellPadding="4" width="96%" border="0" align="center" bgcolor="#ffffff" class="tbcolor">
			<TR class="tbcolor1">
				<th align="center" height="30" colspan="2">
					<span style="FONT-SIZE: 11pt"> 修改指标公式:<logic:present name="indexName" scope="request">
							<bean:write name="indexName" />
						</logic:present></span>
				</th>
			</TR>
			<tr>
				...
				<td bgcolor="#ffffff" width="center">
					<table cellSpacing="0" cellPadding="0" width="100%" border="0" align="center" class="tbcolor">
						<tr bgcolor="#ffffff" height="90">
							...
							<td colspan="1">
								<textArea name="formual" class="input-text" rows="10" style="width:90% " id="idrFormula" ONSELECT="storeCaret(this);" ONCLICK="storeCaret(this);" ONKEYUP="storeCaret(this);" onfocus="textAreaOnFocus(this)"><logic:present name="IdrFormula" scope="request"><bean:write name="IdrFormula"/></logic:present></textArea>
							</td>							
						</tr>
						<tr bgcolor="#ffffff" height="90">
							<td valign="middle" width="10%" align="center">
							...
							<td colspan="1">
								<textArea name="desc" class="input-text" rows="3" style="width:90% " id="formulaDesc" ><logic:present name="desc" scope="request"><bean:write name="desc"/></logic:present></textArea>
							</td>							
						</tr>
					</table>
