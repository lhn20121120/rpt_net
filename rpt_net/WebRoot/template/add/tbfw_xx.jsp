...
<html:html locale="true">
	<head>
		...
		<script language="javascript">
		  	...
		  	function _back(){
				...
				var childRepId="<bean:write name='ChildRepId' scope='request'/>";
			  </logic:present>
			  <logic:present name="VersionId" scope="request">
				var versionId="<bean:write name='VersionId' scope='request'/>";
			  </logic:present>
			  <logic:present name="ReportStyle" scope="request">
				var reportStyle="<bean:write name='ReportStyle' scope='request'/>";
			  </logic:present>
			  ...
			  window.location="<%=request.getContextPath()%>/template/returnYCBH.do?" + 
	...
	<html:form action="/template/viewMOrg" method="post">
						...
						<tr>
							<td align="center">
								<fieldset id="fieldset">
									...
									<html:form action="/template/operationOrgType" method="post" styleId="form2">
										...
										<logic:present name="ReportStyle" scope="request">
											<input type="hidden" name="reportStyle" value="<bean:write name='ReportStyle' scope='request'/>">
										</logic:present>
										...
										<tr>
											...
											<tr>
												<td align="right">
													...
													<html:button property="back" styleClass="input-button" onclick="_back()" value="返回异常变化标准设定"/>
												</td>
											</tr>
									</table>
									</html:form>
