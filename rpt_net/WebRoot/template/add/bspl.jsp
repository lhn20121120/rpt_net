...
<%
	...
	//System.out.println(system_schema_id);
%>
				...
				<logic:present name="utilForm" scope="page">
					<logic:iterate id="item" name="utilForm" property="dataRgTypes">
						<tr bgcolor="#FFFFFF">
							...
							%>
							<TD align="center">
								<input class="input-text" type="text" size="6" name="normalTimes"  maxlength="3" value="1" readonly="readonly" title="默认值不需修改">
							</TD>
							<TD align="center">
								<input class="input-text" type="text" size="6" name="delayTimes" maxlength="3"  value="1" readonly="readonly" title="默认值不需修改">
							</TD>
