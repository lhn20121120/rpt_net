...
<body>
	...
	<form action="${pageContext.request.contextPath}/uploadFileAction.do?m=execUpload" id="uploadForm" method="post" enctype="multipart/form-data">
		<table cellpadding="4" cellspacing="1" border="0" width="70%" align="center" class="tbcolor">
			...
			<tr bgcolor="#ffffff" height="40px">
				...
				<td width="20%"><font id="ft" color="red">(支持上传zip,文本格式文件)</font></td>
			</tr>
