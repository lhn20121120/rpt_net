 	...
 	<table width="95%"  border="0" align="center">
		  ...
		  <tr>
		    <td align="right">
		    	...
		    	<html:button property="addMOrgClsnet" value="增加机构分类" styleClass="input-button" onclick="location.assign('./orgtogether_net/orgclsnet_add.jsp')"/>
		    </td>
		  </tr>
		  <tr>
		  	<td height="5">
  ...
  <table width="90%" border="0" cellpadding="6" cellspacing="1" class="tbcolor">
       <tr class="titletab">
		...
		<logic:present name="Records" scope="request">
			    ...
			    &orgClsType=<bean:write name="item" property="orgClsType"/>">修改</a>
			                </td>
			                <td bgcolor="#ffffff">
			                	<a href="javascript:deleteOrgClsNet('<bean:write name="item" property="orgClsId"/>')">删除</a>
			                </td>
			         </tr>
				</logic:iterate>
		  </logic:present>
