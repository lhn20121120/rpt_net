...
<html:html locale="true">
  ...
  <body>
	...
	MRegionForm mRegionForm=(MRegionForm)request.getAttribute("mRegionForm");
	String regionId=String.valueOf(mRegionForm.getRegion_id().intValue());
	String regionName=mRegionForm.getRegion_name();	
	%>
	
		<html:form action="/updateMRegion" method="post" onsubmit="return _submit(this)">
					  ...
					  <TD>
						<table border="0" width="100%" align="center" cellspacing="1" cellpadding="4">
						  <TR>
						    ...
						    <TD><html:hidden property="region_id" value="<%=regionId%>"/></TD>
				          </TR>
						  <TR>
						    <TD align="right">地区名称：</TD>
						    <TD><html:text property="region_name" size="20" styleClass="input-text" maxlength="20" value="<%=regionName%>"/></TD>
				          </TR>				          
				          <TR>
	...
	<SCRIPT language="javascript">
		...
		function _back()
		{
		window.location="<%=request.getContextPath()%>/viewMRegion.do";
		}	    
	</SCRIPT>
</html:html>
