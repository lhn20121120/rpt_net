...
// Images Directory
imagesDir = "<%=request.getContextPath()%>/bulletin/editor/icons/";

// CSS Directory
cssDir = "<%=request.getContextPath()%>/bulletin/editor/styles/";

// Popups Directory
popupsDir = "<%=request.getContextPath()%>/bulletin/editor/popups/";
