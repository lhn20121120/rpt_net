									...
									<table width="100%" border="0">
										<tr>
											...
											<input type="hidden" name="bullId" value="<%=bullId %>"/>
												标题: <INPUT name="bullTitle" value="<%=bullTitle %>" size="50"/>&nbsp;&nbsp;状态：
												<select name="bullState">
												<option value="1" <%if(bullState==1) out.print("selected"); %>>登陆提示</option>
												<option value="2" <%if(bullState==2) out.print("selected"); %>>登陆不提示</option>
											</select>
											</td>
									    </tr>							
