			  ...
			  */
			   ...
			   */ 
			   function _back(){
	  		 	 ...
	  		 	 window.location="<%=request.getContextPath()%>/analysis/viewMChildReport.do?" +
...
<body background="../image/total.gif">
	...
	<form method="post"  name="frm" action="<%=request.getContextPath() %>/analysis/analyUpdateYCBH.do" onsubmit="return _submitFrm()">
