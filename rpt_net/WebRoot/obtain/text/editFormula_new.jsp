...
<table width="100%" height=100% border="0" cellspacing="0" cellpadding="0" align="center">
   ...
   <html:form method="post" action="/obtain/text/updateformula" enctype="multipart/form-data"  onsubmit="return _submit()">
			...
			<input type="hidden" name="id" value="<bean:write name='ObjForm' property='id'/>">
			<input type="hidden" name="childReportId" value="<bean:write name='ObjForm' property='childReportId'/>">
