...
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
	...
	<script language="javascript">
		...
		function editDepart(deptName,departmentId){
...
<body >
  ...
  <table width="90%" border="0" cellpadding="4" cellspacing="1" class="tbcolor">
		  ...
		  <logic:present name="Records" scope="request">
				<logic:iterate id="item" name="Records" indexId="index">
					 <tr align="center" >
			                ...
			                <td bgcolor="#ffffff">
			                <a href="javascript:editDepart('<bean:write name="item" property="deptName"/>','<bean:write name="item" property="departmentId"/>')">修改</a>
			                </td>
			                <td bgcolor="#ffffff">
	...
	<form style="display:none" id="hiddenForm" method="post" action="../dept_info_mgr/dept_update.jsp">
		<input name="deptName" id="deptNameInput"/>
		<input name="departmentId" id="departmentIdInput"/>
	</form>
</body>
</html:html>
