		...
		<tr > 
		   <td>
		    ...
		    <td align="right">	
		    	<%if(!Config.PORTAL){
		    		%>
		    		<html:button property="addDept" value="增加用户" styleClass="input-button" onclick="location.replace('${pageContext.request.contextPath }/popedom_mgr/user_mgr/user_add.jsp')"/>
		    		<%
		    	} %>	    			    	
		    </td>	
		  </tr>
