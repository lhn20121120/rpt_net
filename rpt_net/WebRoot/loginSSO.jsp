...
<%
	...
	//String data = (String)session.getAttribute("nbk");
	String data = request.getHeader("SMUNIVERSALID");

%>
	<head>
	<html:base/>
		<title>美国银行报送系统单点用户登录</title>
  ...
  <body bgcolor="#FFFFFF" onload="initMethod()">
    ...
    <td><table align="left" border="0" cellpadding="0" cellspacing="0" width="778">
      <!--DWLayoutTable-->
        <tr>
          ...
          <td width="247" valign="top">
	          <table width="100%" border="0" cellpadding="0" cellspacing="0" background="image/login_r5_c3.jpg">
	            ...
	            <tr>
	              <td height="35">&nbsp;</td>
	              <td valign="top" >
	                      <input name="userName" type="text" size="20" maxlength="20" value="<%=data%>" readonly></td>
	              <td>&nbsp;</td>
	            </tr>
	            <tr>
	              <td height="35">&nbsp;</td>
	              <td valign="top" >
	              	<input type="password" name="password" size="20" maxlength="40" autocomplete="off" value="aaa" readonly/>
	              </td>
	              <td>&nbsp;</td>
	            </tr>
	            <tr>
          ...
          <td width="169" align="center"><input type="image" onclick="submitData" src="image/login_r5_c4.jpg" width="163" height="142">
        </tr>
    </table></td>
