...
<html>
  <head>
    ...
    <title>My JSP 'shujuchaxun_result.jsp' starting page</title>
  ...
  <div id="findLastDIV" style="overflow: auto;width:100%;height:100%;border:none;position: absolute; ">
   <table style='width:100%;' id="dataTable" align='center' align='center' cellpadding='0' cellspacing='0' >
   							<tr>
								<th colspan="7" align="left" style="border-top:1px dotted #c4c4c4;border-right:1px dotted #c4c4c4;background-color: #E5EEFF">
									<a href="javascript:location.href='<%=request.getContextPath() %>/searchDataInitAction.do'" class="easyui-linkbutton"  plain="true" iconCls="icon-back">返回</a>
							...
							%>
									...
									<tr name="<%=obj[1] %>" align='center'  onclick="changeBgColor(this)" style="cursor: hand">
										<td><%=obj[0] %></td>
										<td><%=obj[1] %></td>
										<td><%=obj[2] %></td>
										...
										<td><%=obj[4] %></td>
										<td><%=obj[5] %></td>
										<td style="border-right:1px dotted #c4c4c4"><%=obj[6] %></td>
									</tr>
							<%
									}
								}else{
