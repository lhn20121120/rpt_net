		...
		<!--
			 ...
			 */
			 function _load_gx(){
			 	 ...
			 	 window.location="<%=request.getContextPath()%>/gznx/reportmgr/load_gx.jsp?" + 
			  ...
			  */
			   ...
			   */
			   function _next(){
			     	var form=document.forms['frmBJGX'];				  	
				   if("<%=reportFlg%>"=="3"){
			  			window.location="<%=request.getContextPath()%>/gznx/viewBSFW.do" + 
		...
		<tr>
			<td>
				<fieldset id="fieldset">
					...
					<br>
					<form name="frmBJGX" method="post" action="<%=request.getContextPath()%>/gznx/saveBJGX.do?flag=add" onsubmit="return _submit(this)">
