									...
									<logic:present name="Records" scope="request">
											<logic:iterate id="item" name="Records">
												<TR bgcolor="#FFFFFF"  onmouseover="changeToLavender(this)" onmouseout="changeToWhite(this)">
													...
													--%>
													<TD align="center">
														<a href="javascript:goHZRule('<bean:write name="item" property="templateId"/>','<bean:write name="item" property="versionId"/>','<bean:write name="item" property="reportName"/>','<bean:write name="item" property="orgId"/>')">汇总公式设定</a>
													</TD>
												</TR>
											</logic:iterate>
									</logic:present>
