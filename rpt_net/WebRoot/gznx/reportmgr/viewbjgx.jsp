...
<head>
	...
	<script language="javascript">
		function goBack()
		{
			window.location = "./viewAFTemplateDetail.do?templateId=<bean:write name="ChildRepId"/>&templateName=<bean:write name="ReportName"/>&versionId=<bean:write name="VersionId"/>";
		}
	</script>
</head>
<body background="../../image/total.gif">
	...
	<table border="0" cellspacing="0" cellpadding="4" width="95%" align="center">
		<tr><td height="8"></td></tr>
			<tr>
				<td>
					当前位置 >> 报表管理 >> 模板查看 >> 查看详细信息 >> 查看表内表间关系
				</td>
			</tr>
