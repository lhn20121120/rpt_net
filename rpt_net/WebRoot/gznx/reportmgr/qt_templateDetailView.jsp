						...
						<logic:iterate id="item" name="Records">
							<TR bgcolor="#FFFFFF">
								...
								<TD  align="center" width="10%">
									...
									<a href="javascript:viewAFRepRange('<%=orgId%>','<bean:write name="item" property="templateId"/>','<bean:write name="item" property="versionId"/>','<bean:write name="item" property="templateName"/>')">查看</a>
								</TD>
								<TD  align="center" width="10%">
