...
<html:html locale="true">
	<head>
		...
		<script language="javascript">	
			...
			function downAll(){
				window.location="<%=request.getContextPath()%>/servlets/DownloadServlet?type=all";
			}
	</script>
	</head>
	<body style="TEXT-ALIGN: center">
		...
		<html:form action="/exportPbocAFReport.do" method="POST" styleId="frmChk" >
			...
			<TABLE cellSpacing="0" width="98%" border="0" align="center" cellpadding="4">
				<tr>
					<td style="text-align: right;padding-right: 10px"><input type="button" class="input-button" onclick="downAll()" value="全部下载"></td>
				</tr>					
				<TR>
					<TD>
						<TABLE cellSpacing="1" cellPadding="5" width="100%" border="0" class="tbcolor">
							...
							<logic:present name="Records" scope="session">
							...
							<logic:present name="adList" scope="session">
							...
							<logic:notPresent name="Records" scope="session">
								<tr bgcolor="#FFFFFF">
