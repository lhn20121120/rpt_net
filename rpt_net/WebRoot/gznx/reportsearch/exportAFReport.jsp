...
function isHiddenQueryTable(){
	...
	function _selAll(){
		...
		function _selExport(){
			...
			//alert("workTaskTemp"+workTaskTemp);
			//旧版标志位
			var versionFlg = 1;
			...
			if(confirm("是否录入说明?")){
						repForm.action="<%=request.getContextPath()%>/gznx/reportsearch/pbocexplane.jsp?parOrgId="+parOrgId;
...
<form method="post" id="repForm">
	...
	<input type="hidden" id="parOrgId" name="urlParam" value="${ parOrgId}"/>
