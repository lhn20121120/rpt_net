...
<%
	...
	String systemSchemaFlag = request.getParameter("systemSchemaFlag")!=null?request.getParameter("systemSchemaFlag"):"";
	String workTaskTemp = request.getParameter("workTaskTemp")!=null?request.getParameter("workTaskTemp"):"";
	String workTaskTerm = request.getParameter("workTaskTerm")!=null?request.getParameter("workTaskTerm"):"";
	String workTaskOrgId = request.getParameter("workTaskOrgId")!=null?request.getParameter("workTaskOrgId"):"";
	String urlParam = request.getParameter("urlParam")!=null?request.getParameter("urlParam"):"";
	String praOrgId = request.getParameter("praOrgId")!=null?request.getParameter("praOrgId"):"";
...
<head>
	...
	<script language="javascript">
			...
			function _back(){
				...
				var systemSchemaFlag=  document.getElementById("systemSchemaFlag").value;	
				//alert("systemSchemaFlag="+systemSchemaFlag)
...
<body>
	...
	<html:form action="/exportPbocAFReport.do" method="POST" styleId="frmChk" onsubmit="return _submit(this)">
	 ...
	 <html:hidden property="systemSchemaFlag" value="<%=systemSchemaFlag%>" styleId="systemSchemaFlag"/>
	 <html:hidden property="workTaskTemp" value="<%= workTaskTemp%>" styleId="workTaskTemp"/>
	 <html:hidden property="workTaskTerm" value="<%= workTaskTerm%>" styleId="workTaskTerm"/>
	 <html:hidden property="workTaskOrgId" value="<%= workTaskOrgId%>" styleId="workTaskOrgId"/>
	 <html:hidden property="urlParam" value="<%= urlParam%>" styleId="urlParam"/>
	 <html:hidden property="praOrgId" value="<%= praOrgId%>" styleId="praOrgId"/>
