...
<%@page import="com.fitech.gznx.po.AfTemplate"%>
					...
					<table cellspacing="0" cellpadding="0" border="0" width="100%" align="center">
						<tr>
							...
							<td height="25">
								...
								<select name="repName">
									<%
										List<AfTemplate> templateList = (List<AfTemplate>)request.getAttribute("templateList");
										if(templateList==null || templateList.size()==0){
									%>
										<option value="">暂无信息</option>
									<%	
										}else{
											for(AfTemplate a : templateList){
									%>
											<option value="<%=a.getTemplateName() %>"><%=a.getTemplateName() %></option>
									<%
											}
										}
									%>
