...
<%
	...
	if(com.cbrc.smis.common.Config.WEB_SERVER_TYPE==0){//珠海现场这个值为0
...
<html:html locale="true">
			 ...
			 */
			  ...
			  */
			  function _back(){
			  	...
			  	window.location="<%=request.getContextPath()%>/gznx/editBJGXInit.do?childRepId=" + form.elements['childRepId'].value +
	...
	<logic:present name="Message" scope="request">
		...
		<table border="0" cellpadding="4" cellspacing="1" width="60%" class="tbcolor">
			...
			<tr>
				<td bgcolor="#FFFFFF">
					<html:form method="post" action="/gznx/uploadBJGX.do?flag=mod" enctype="multipart/form-data" onsubmit="return _submit(this)" styleId="form1">
