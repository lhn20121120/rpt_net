...
<%
	...
	String scheme = "0";
	if(request.getAttribute("schemeid") != null){
		scheme=(String)request.getAttribute("schemeid");
	}
	%>
						...
						<tr bgcolor="#ffffff">
							...
							<td>
								<html:select property="schemeId">
									...
									<%if(scheme.equals(list.get(i).getValidateSchemeId().toString())) {%>
										<option selected="selected" value="<%=list.get(i).getValidateSchemeId()%>"><%=list.get(i).getValidateSchemeName()%></option>
									<%}else{%>
