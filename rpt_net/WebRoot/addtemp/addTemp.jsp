...
function oldZHUpload(){
    //alert("new"+document.getElementById("uploadForm").action);
    refreshOnTime();
    document.getElementById("uploadZForm").action="<%=request.getContextPath()%>/addStTemp.do";
    //showProcessBar();
...
function doNothing()
{
	...
	$.ajax({
        type: 'POST',
        url: '<%=request.getContextPath()%>/addStTemp.do?method=getOverFlag',
        data: {},
        timeout: 10000,
        async:false,
...
<div class="tab_div2">
  ...
  <tr>
    <th align="left">请选择模板包：</th>
    <th align="left">&nbsp;</th>
    </tr>
  <tr>
    <td height="50" align="right">模板压缩包：
          </td>
 <td> <div class="file-box"> 
                    <html:form  styleId="uploadZForm" method="post" action="/addStTemp" enctype="multipart/form-data"  onsubmit="return _submit2(this)">
                    <div align="left">
