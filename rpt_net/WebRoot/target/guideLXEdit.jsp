...
<html:html locale="true">
    ...
    <script type="text/javascript" language="javascript">
      ...
      function trimTxt()
      {   
        var txt = document.forms[0]["businessName"];
        var pattern = /(\s*)/g;
        var value = txt.value.replace(pattern,"");
        txt.value = value;
      }
    </script>
  </head>  
  <body onload="trimTxt()">
	...
	<table border="0" width="90%" align="center">
		...
		<tr>
			 <td>当前位置 >> 	指标分析 >> 指标类型修改</td>
		</tr>
		<tr><td height="10"></td></tr>
	</table>
		<html:form action="/target/updateTargetBusiness.do" method="post"  onsubmit="return inputValid()">
						...
						<table border="0" width="100%" align="center" cellspacing="1" cellpadding="4">
						  <TR>
						   <TD align="center">指标类型名称：<html:text property="businessName" size="20" styleClass="input-text" maxlength="9"/>
				              ...
				              <TR>
				                <TD align="center"><html:submit styleClass="input-button" value="确定"/>
