...
<head>
	...
	<script language="javascript">
		...
		function _goBack(){
			...
			window.location="<%=request.getContextPath()%>/dateQuary/manualCheckRepRecheck.do?" + qry;				
		}
...
<body>
	...
	<center>
		...
		<br>
		<br>
		<html:form action="/dateQuary/saveCheckRepRecheck" method="post" onsubmit="return _submit(this)">
