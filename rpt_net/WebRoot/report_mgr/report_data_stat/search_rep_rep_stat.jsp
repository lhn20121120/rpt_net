					...
					<logic:present name="Records" scope="request">
						<logic:iterate id="viewReportIn" name="Records">							
							<TR bgcolor="#FFFFFF">
								...
								<TD align="center">
									<bean:write name="viewReportIn" property="repDay" />
								</TD>
								<TD align="center">
									<logic:present name="reportTimeUnit" scope="request">
										<bean:write name="viewReportIn" property="finalLaterDate" format="yyyy-MM-dd hh:mm:ss"/>
									</logic:present>
									<logic:notPresent name="reportTimeUnit" scope="request">
										<bean:write name="viewReportIn" property="finalLaterDate" format="yyyy-MM-dd"/>
									</logic:notPresent>
								</TD>
								<TD align="center">
