...
<html:html locale="true">
  ...
  <body>
	...
	<table border="0" width="90%" align="center">
		...
		<tr>
			 <td>当前位置 >> 	参数设定 >> 报表类别修改</td>
		</tr>
		<tr><td height="10"></td></tr>
	</table>
		<html:form action="/config/UpdateRepType" method="post">
					 ...
					 <TR align="center" valign="middle" bgcolor="#FFFFFF">
					   <TD>
						<table border="0" width="100%" align="center" cellspacing="1" cellpadding="4">
						  <TR>
						   <TD align="center">报表类别名称：<html:text property="repTypeName" size="20" styleClass="input-text" maxlength="20"/>
				           </TD>
				          </TR>
				              <TR>
				                <TD align="center">
				                  <html:submit styleClass="input-button" value="确定"/>
				                  <html:hidden property="repTypeId"/>
