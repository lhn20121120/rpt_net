...
<html:html locale="true">
  ...
  <body>
	<table border="0" width="90%" align="center">
		...
		<html:form action="/config/InsertCurVerifyType" method="post">
					...
					<TR align="center" valign="middle" bgcolor="#FFFFFF">
					  <TD>
						<table border="0" width="100%" align="center" cellspacing="1" cellpadding="4">
						  <TR>
						    <TD align="center">校验类别名称：<html:text property="validateTypeName" size="20" maxlength="20" styleClass="input-text"/>
						    </TD>
				          </TR>
					           <TR>
					             <TD align="center">
