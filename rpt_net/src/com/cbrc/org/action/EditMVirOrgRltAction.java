...
/**
 * Open form for editing MVirOrgRlt.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editMVirOrgRlt"
 *
 ...
 */
public final class EditMVirOrgRltAction extends Action {
   ...
   public ActionForward perform(
      ...
      try {
         ...
         session.setAttribute("MVirOrgRltForm", MVirOrgRltForm);
      } catch (Exception e) {
