...
/**
 * Open form for editing MVirOrgType.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editMVirOrgType"
 *
 * @struts.action-forward
 *    name="form"
 *    path="/struts/formMVirOrgType.jsp"
 *    redirect="false"
 *

 */
public final class EditMVirOrgTypeAction extends Action {
   ...
   public ActionForward perform(
      ...
      MVirOrgTypeForm MVirOrgTypeForm = new MVirOrgTypeForm();
      ...
      try {
         ...
         session.setAttribute("MVirOrgTypeForm", MVirOrgTypeForm);
      } catch (Exception e) {
