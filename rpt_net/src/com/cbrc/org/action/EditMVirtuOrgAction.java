...
/**
 * Open form for editing MVirtuOrg.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editMVirtuOrg"
 *
 ...
 */
public final class EditMVirtuOrgAction extends Action {
   ...
   public ActionForward perform(
      ...
      MVirtuOrgForm MVirtuOrgForm = new MVirtuOrgForm();
      ...
      try {
         ...
         session.setAttribute("MVirtuOrgForm", MVirtuOrgForm);
      } catch (Exception e) {
