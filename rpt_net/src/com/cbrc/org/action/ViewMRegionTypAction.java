...
/**
 * Displays a MRegionTyp. We'll first try to look for a MRegionTyp
 ...
 */
public final class ViewMRegionTypAction extends Action {
   ...
   public ActionForward perform(
      ...
      MRegionTypForm MRegionTypForm = (MRegionTypForm)request.getAttribute("MRegionTyp");
      if( MRegionTypForm == null ) {
         // The vo wasn't on the request. We came via a direct link.
         // Get pk data from request object and use delegate to lookup
         try {
            MRegionTypForm = new MRegionTypForm();
      ...
      // Make a map that can be used to identify this MRegionTyp in any links
      HashMap urlParams = new HashMap();
  urlParams.put("regionTypId",MRegionTypForm.getRegionTypId());
