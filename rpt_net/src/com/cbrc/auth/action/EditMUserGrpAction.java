...
/**
 * Open form for editing MUserGrp.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editMUserGrp"
 *
 ...
 */
public final class EditMUserGrpAction extends Action {
   ...
   public ActionForward perform(
      ...
      try {
         MUserGrpForm = null;//com.cbrc.auth.adapter.StrutsMUserGrpDelegate.edit(MUserGrpForm);
         session.setAttribute("MUserGrpForm", MUserGrpForm);
      } catch (Exception e) {
         getServlet().log("Create error", e);
         request.setAttribute("name", "MUserGrp");
