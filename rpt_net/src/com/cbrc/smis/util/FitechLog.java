...
public class FitechLog {
	 ...
	 * @param memo
	 */
	public static void writeLoginLog(int logType,String orgName,String operation,String memo){
		StrutsLogInDelegate.createLoginLog(logType, orgName, operation, memo);
	}	
