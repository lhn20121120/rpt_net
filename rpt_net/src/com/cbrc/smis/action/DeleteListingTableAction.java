...
/**
 * Deletes a listingTable.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/deleteListingTable"
 *
 ...
 */
public final class DeleteListingTableAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         com.cbrc.smis.adapter.StrutsListingTableDelegate.remove(listingTableForm);
      } catch (Exception e) {
