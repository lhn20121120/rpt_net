...
/**
 * Updates a MCellFormu.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/updateMCellFormu"
 *    name="MCellFormuForm"
 *    scope="session"
 *    validate="false"
 *
 ...
 */
public final class UpdateMCellFormuAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         MCellFormuForm = com.cbrc.smis.adapter.StrutsMCellFormuDelegate.update(MCellFormuForm);
