...
/**
 * Open form for editing documentDetail.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editDocumentDetail"
 *
 * @struts.action-forward
 *    name="form"
 *    path="/struts/formDocumentDetail.jsp"
 *    redirect="false"
 *

 */
public final class EditDocumentDetailAction extends Action {
   ...
   public ActionForward execute(
      ...
      DocumentDetailForm documentDetailForm = new DocumentDetailForm();
      ...
      try {
         ...
         session.setAttribute("documentDetailForm", documentDetailForm);
      } catch (Exception e) {
