 ...
 */
public final class DeleteMActuRepAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         com.cbrc.smis.adapter.StrutsMActuRepDelegate.remove(MActuRepForm);
      } catch (Exception e) {
         getServlet().log("Remove error", e);
         request.setAttribute("name", "MActuRep");
