...
/**
 * Deletes a calendarType.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/deleteCalendarType"
 *
 ...
 */
public final class DeleteCalendarTypeAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         com.cbrc.smis.adapter.StrutsCalendarTypeDelegate.remove(calendarTypeForm);
      } catch (Exception e) {
