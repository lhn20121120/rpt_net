...
/**
 * Open form for editing listingTable.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editListingTable"
 *
 ...
 */
public final class EditListingTableAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         ...
         session.setAttribute("listingTableForm", listingTableForm);
      } catch (Exception e) {
