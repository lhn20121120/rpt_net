...
public final class ViewPreBSFWAction extends Action {
	/**
	 * Performs action.
	 * 
	 * @param mapping
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String fileName = Config.WEBROOTPATH + "xml"+Config.FILESEPARATOR+"bsfw.xml"; // 创建一个XML文件
		...
		request.setAttribute("xmlorgname", fileName);
	...
	private void addChild(Element e, AfOrg orgNet, HttpSession session) {
		if (orgNet != null) {
			...
			//生成机构树xml ，读取 af_org表。原先读取的是 org表
