...
/**
 * Open form for editing calendar.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editCalendar"
 *
 ...
 */
public final class EditCalendarAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         ...
         session.setAttribute("calendarForm", calendarForm);
      } catch (Exception e) {
