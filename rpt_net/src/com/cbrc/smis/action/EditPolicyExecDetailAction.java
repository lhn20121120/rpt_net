...
/**
 * Open form for editing policyExecDetail.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editPolicyExecDetail"
 *
 ...
 */
public final class EditPolicyExecDetailAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         ...
         session.setAttribute("policyExecDetailForm", policyExecDetailForm);
      } catch (Exception e) {
