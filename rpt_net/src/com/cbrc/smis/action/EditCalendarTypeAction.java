...
/**
 * Open form for editing calendarType.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editCalendarType"
 *
 * @struts.action-forward
 *    name="form"
 *    path="/struts/formCalendarType.jsp"
 *    redirect="false"
 *

 */
public final class EditCalendarTypeAction extends Action {
   ...
   public ActionForward execute(
      ...
      CalendarTypeForm calendarTypeForm = new CalendarTypeForm();
      ...
      try {
         ...
         session.setAttribute("calendarTypeForm", calendarTypeForm);
      } catch (Exception e) {
