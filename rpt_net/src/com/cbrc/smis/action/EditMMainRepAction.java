...
/**
 * Open form for editing MMainRep.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/editMMainRep"
 *
 ...
 */
public final class EditMMainRepAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         ...
         session.setAttribute("MMainRepForm", MMainRepForm);
      } catch (Exception e) {
