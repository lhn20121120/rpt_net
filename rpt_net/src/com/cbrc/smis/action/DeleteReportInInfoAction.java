...
/**
 * Deletes a reportInInfo.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/deleteReportInInfo"
 *
 ...
 */
public final class DeleteReportInInfoAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         com.cbrc.smis.adapter.StrutsReportInInfoDelegate.remove(reportInInfoForm);
      } catch (Exception e) {
