...
/**
 * Deletes a documentDetail.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/deleteDocumentDetail"
 *
 ...
 */
public final class DeleteDocumentDetailAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         com.cbrc.smis.adapter.StrutsDocumentDetailDelegate.remove(documentDetailForm);
      } catch (Exception e) {
