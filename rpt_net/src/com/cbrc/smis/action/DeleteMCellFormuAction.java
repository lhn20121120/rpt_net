...
/**
 * Deletes a MCellFormu.
 *
 * @author <a href="http://boss.bekk.no/boss/middlegen/">Middlegen</a>
 *
 * @struts.action
 *    path="/struts/deleteMCellFormu"
 *
 ...
 */
public final class DeleteMCellFormuAction extends Action {
   ...
   public ActionForward execute(
      ...
      try {
         com.cbrc.smis.adapter.StrutsMCellFormuDelegate.remove(MCellFormuForm);
      } catch (Exception e) {
