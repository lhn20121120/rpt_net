 ...
 */
public final class EditMCurrAction extends Action {
	private static FitechException log=new FitechException(EditMCurrAction.class);
   ...
   public ActionForward execute(
     ...
     //将request对象传回
      ...
      try {
    	   com.cbrc.smis.adapter.StrutsMCurrDelegate.selectOne(mCurrForm);
    	 
    	  if (mCurrForm==null) 
    	  {
    		  // System.out.println("mCurrForm mCurrName  EMPTY!!!");
    	  }
         ...
         request.setAttribute(Config.CUR_PAGE_OBJECT,curPage);    	  
    	  ...
    	  log.printStackTrace( e);
      		...
      		path=path.equals("")?"/config/ViewCurr.do":path;
