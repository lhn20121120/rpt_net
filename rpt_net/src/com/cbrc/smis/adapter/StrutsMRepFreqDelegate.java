...
public class StrutsMRepFreqDelegate {
	...
	public static List findAll() throws Exception {
		...
		StringBuffer hql = new StringBuffer("from MRepFreq a  order by a.repFreqId");
	...
	public static List findAllFeq() throws Exception {
		...
		StringBuffer hql = new StringBuffer(
				"from MRepFreq a where a.repFreqName in ").append(rep_freq).append(" order by a.repFreqId");
	...
	public static List findRHAllFeq() throws Exception {
		...
		Session session = null;
		// 查询条件HQL的生成
		String rep_freq = "('日','旬','月','季','半年','年','年初结转')";
		StringBuffer hql = new StringBuffer(
				"from MRepFreq a where a.repFreqName in ").append(rep_freq).append(" order by a.repFreqId");
