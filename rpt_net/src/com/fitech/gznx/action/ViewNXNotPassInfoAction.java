 ...
 * jcm
 */
public class ViewNXNotPassInfoAction extends Action {
	private FitechException log=new FitechException(ViewNXNotPassInfoAction.class);
		...
		try{			
			...
			if(repInId!=null){		
				...
				if(reportInForm!=null){
					...
					reportStyle = AFTemplateDelegate.getReportStyle(childRepId,versionId);					
