...
public class DateUtil {
	...
	public static String getFreqDateLast(String date, Integer freq) {
		...
		if (freq.equals(Config.FREQ_DAY))
			...
			return DateUtil.getMonthLast(date);
	}
...
//			calStart.add(Calendar.MONTH, 3);// 增加一个季度
	...
	/**
	 * 根据输入的指定年月日返回该日期属于周几,周1就返回1，周五就返回5，以此类推，注意周日返回0
	 * @param int year
	 * @param int month
	 * @param int day
	 * @return
    ...
    /**
     * 根据输入的指定日期(yyyy-MM-dd)返回该日期属于周几,周1就返回1，周五就返回5，以此类推，注意周日返回0
     * @param Stirng date
     * @return
     * @throws Exception
     */
	...
	public static void main(String args[]) throws Exception{
		...
		System.out.println(getDayOfWeek("2014-05-09"));
