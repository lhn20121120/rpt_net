...
public class AFReportmerger extends DaoModel{
	

	private static FitechException log = new FitechException(AFReportmerger.class); 
	...
	public static boolean updateUsingFlag(String templateId, String versionId)  throws Exception {    
