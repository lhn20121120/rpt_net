...
public class OrgValiInfo implements java.io.Serializable{
	...
	public OrgValiInfo(Long id,String org_name,String rol_name,String cell_data,String rep_id,String template_id,String org_id,String cell_name,String flag){
	this.id=id;
