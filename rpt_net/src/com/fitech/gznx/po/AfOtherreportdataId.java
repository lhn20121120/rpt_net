...
/**
 * AfOtherreportdataId entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class AfOtherreportdataId implements java.io.Serializable {
	...
	/** default constructor */
	public AfOtherreportdataId() {
	}

	/** full constructor */
	public AfOtherreportdataId(Long repId, Long cellId) {
		this.repId = repId;
		this.cellId = cellId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AfOtherreportdataId))
			return false;
		AfOtherreportdataId castOther = (AfOtherreportdataId) other;
