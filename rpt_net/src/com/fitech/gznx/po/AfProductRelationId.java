...
public class AfProductRelationId implements java.io.Serializable {
	...
	/** default constructor */
	public AfProductRelationId() {
	}

	/** full constructor */
	public AfProductRelationId(String collectId, String orgId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AfProductRelationId))
			return false;
		AfProductRelationId castOther = (AfProductRelationId) other;
