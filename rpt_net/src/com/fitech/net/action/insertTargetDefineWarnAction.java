...
public final class insertTargetDefineWarnAction extends Action {
    private static FitechException log = new FitechException(
    		insertTargetDefineWarnAction.class);
  ...
  boolean result=false;
        ...
        try
        {
        	...
        	if(result==true)messages.add("预警规则增加成功！");
        }
        catch(Exception e)
        {
        	log.printStackTrace(e);
        	messages.add("预警规则增加失败！");
