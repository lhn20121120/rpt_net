 ...
 * @author yaojie
 */
public final class ViewDataRelationFormualSettingAction extends Action
{
	private static FitechException log = new FitechException(ViewDataRelationFormualSettingAction.class);
