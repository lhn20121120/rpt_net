...
public class StrutsMRegionDelegate {
   ...
   public static MRegionForm selectOne(MRegionForm mRegionForm){
	...
	public static List findAll () throws Exception {
		...
		DBConn conn = null;
		Session session = null;
		StringBuffer hql = new StringBuffer("from MRegion m order by m.regionName");
...
//					}
	 ...
	 * 查找上级地区
	 */
	public static MRegion findPreMRegionId(Integer regionId){
	 ...
	 * 查找一条记录
	 */
	public static MRegion selectOne(Integer regionId){
		MRegion mRegionResult = null;
		DBConn conn = null;
		Session session = null;
	 ...
	 * 查询下一级子地区
	 */
	public static List getLowerRegions(Integer regionId)
	{
		List list=null;
	 ...
	 * 查询下一级子地区
	 */
	public static List getLowerMRegionForms(Integer regionId)
	{
		List relist=null;
		DBConn conn=new DBConn();
		Session session=conn.openSession();
