...
public class S3403Record {
	...
	public double getG() {
		return Double.parseDouble(StringTool.deleteDH(this.getG1()))+Double.parseDouble(StringTool.deleteDH(this.getG2()))+Double.parseDouble(StringTool.deleteDH(this.getG3()));
	}
