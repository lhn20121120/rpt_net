 ...
 */
public class CopyReportform extends ActionForm {
 ...
 */
public void setOrgName(java.lang.String name) {
	_orgName = name;
}

/**
 * @return Returns the _repFreqName.
 */
...
/**
 * @param freqName The _repFreqName to set.
 */
public void setRepFreqName(java.lang.String freqName) {
	_repFreqName = freqName;
}

/**
 * @return Returns the latertime.
 */
...
/**
 * @param latertime The latertime to set.
 */
